# Generated by Django 2.1.4 on 2019-07-22 17:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FPassage', models.CharField(blank=True, max_length=32, null=True, verbose_name='通道名称')),
                ('FDevID', models.CharField(blank=True, max_length=32, null=True, verbose_name='设备编号')),
                ('FAreaID', models.CharField(blank=True, max_length=32, null=True, verbose_name='区域编号')),
                ('FType', models.IntegerField(blank=True, choices=[(None, '请选择数据'), (0, '入口'), (1, '出口')], null=True, verbose_name='通道类型')),
