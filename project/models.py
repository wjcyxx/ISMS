...
class project(models.Model):
    ...
    FConsultOrgID = models.CharField(max_length=50, verbose_name='咨询单位', blank=True, null=True)
    FConsultAtten = models.CharField(max_length=32, verbose_name='咨询单位联系人', blank=True, null=True)
    FConsultAttenTel = models.CharField(max_length=32, verbose_name='咨询单位联系人电话', blank=True, null=True)
